...
OAUTH2_APP_NAME = "drf_yasg2 OAuth2 provider"

OAUTH2_REDIRECT_URL = static_lazy("drf_yasg2/swagger-ui-dist/oauth2-redirect.html")
...
SWAGGER_SETTINGS = {
    ...
    "SECURITY_DEFINITIONS": {
        ...
        "OAuth2 password": {
            "flow": "password",
            "scopes": {"read": "Read everything.", "write": "Write everything,",},
            "tokenUrl": OAUTH2_TOKEN_URL,
            "type": "oauth2",
        },
        "Query": {"in": "query", "name": "auth", "type": "apiKey",},
    },
...
LOGGING = {
    ...
    "loggers": {
        ...
        "django": {"handlers": ["console_log"], "level": "INFO", "propagate": False,},
    ...
    "root": {"handlers": ["console_log"], "level": "INFO",},
}
