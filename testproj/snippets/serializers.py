...
class ExampleProjectSerializer(serializers.Serializer):
    project_name = serializers.CharField(
        label="project name custom title", help_text="Name of the project"
    )
    github_repo = serializers.CharField(
        required=True, help_text="Github repository of the project"
    )
...
class SnippetSerializer(serializers.Serializer):
    ...
    example_projects = serializers.ListSerializer(
        child=ExampleProjectSerializer(),
        read_only=True,
    ...
    rate_as_string = serializers.DecimalField(
        max_digits=6,
        decimal_places=3,
        default=Decimal("0.0"),
