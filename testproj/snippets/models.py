...
class Snippet(models.Model):
    ...
    style = models.CharField(
        choices=STYLE_CHOICES, default="solarized-dark", max_length=100
    )
...
class SnippetViewer(models.Model):
    snippet = models.ForeignKey(
        Snippet, on_delete=models.CASCADE, related_name="viewers"
    )
    viewer = models.ForeignKey(
        "auth.User", related_name="snippet_views", on_delete=models.CASCADE
    )
