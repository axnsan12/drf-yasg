...
class BaseInspector:
    def __init__(
        ...
        :param swagger_settings: if given global swagger_settings are overridden with
            local settings
        """
        self.view = view
        self.path = path
...
class FieldInspector(BaseInspector):
    ...
    def __init__(
        ...
        super(FieldInspector, self).__init__(
            view, path, method, components, request, swagger_settings
        )
...
class ViewInspector(BaseInspector):
    ...
    def filter_inspectors(self):
        return (
            self._filter_inspectors or self.swagger_settings.DEFAULT_FILTER_INSPECTORS
        )
    ...
    def paginator_inspectors(self):
        return (
            self._paginator_inspectors
            or self.swagger_settings.DEFAULT_PAGINATOR_INSPECTORS
        )
    ...
    def __init__(
        ...
        :param swagger_settings: if given global swagger_settings are overridden with
            local settings
        """
        super(ViewInspector, self).__init__(
            view, path, method, components, request, swagger_settings
        )
