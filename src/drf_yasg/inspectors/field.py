    ...
    def field_to_swagger_object(
        ...
        if serializer:
            ...
            try:
                ...
                # try handling forward references with Python 3.12 type parameters (PEP-695),
                # which are not defined in the module scope and will not resolve if postponed
                # evaluation of annotations (PEP-563) is enabled.
                localns = {
                    t.__name__: t
                ...
                # if there are no type parameters or the module isn't loaded then don't bother
