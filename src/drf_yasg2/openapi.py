    ...
    def __init__(self, *scopes, **kwargs):
        ...
        if not force_init:
            raise AssertionError(
                ...
                "See https://github.com/joellefkowitz/drf-yasg/issues/211, "
                "https://github.com/joellefkowitz/drf-yasg/issues/271, "
                "https://github.com/joellefkowitz/drf-yasg/issues/325.\n"
