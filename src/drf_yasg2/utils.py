...
def swagger_auto_schema(
    ...
    **extra_overrides
    ...
    :param drf_yasg2.inspectors.SwaggerAutoSchema auto_schema: custom class to use for generating the Operation object;
    ...
    :param list[drf_yasg2.openapi.Parameter] manual_parameters: a list of manual parameters to override the
...
def param_list_to_odict(parameters):
    ...
    :param list[drf_yasg2.openapi.Parameter] parameters: the list of parameters
    :return: `parameters` keyed by ``(name, in_)``
    :rtype: dict[(str,str),drf_yasg2.openapi.Parameter]
    """
...
def merge_params(parameters, overrides):
    ...
    :param list[drf_yasg2.openapi.Parameter] parameters: initial parameters
    :param list[drf_yasg2.openapi.Parameter] overrides: overriding parameters
    :return: merged list
    :rtype: list[drf_yasg2.openapi.Parameter]
    """
...
def force_real_str(s, encoding="utf-8", strings_only=False, errors="strict"):
    ...
    Fix for https://github.com/joellefkowitz/drf-yasg/issues/159
    """
    if s is not None:
